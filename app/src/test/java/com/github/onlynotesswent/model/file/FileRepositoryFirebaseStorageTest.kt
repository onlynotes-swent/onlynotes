...
class FileRepositoryFirebaseStorageTest {
  ...
  //        `when`(mockStorageReference.getFile(any<File>())).thenReturn(any())
  //
  //        fileRepository.downloadFile(uid, fileType, cacheDir, onSuccess = {
  //            // Success callback
  //            assertNotNull(it)
  //        }, onFailure = {
  //            // Failure callback
  ...
  //
  //        `when`(mockStorageReference.child(anyString())).thenReturn(mockStorageReference)
  //        `when`(mockStorageReference.delete()).thenReturn(any())
  //
  //        fileRepository.deleteFile(uid, fileType, onSuccess = {
  //            // Success callback
  //            assert(true)
  //        }, onFailure = {
  //            // Failure callback
  ...
  //
  //        `when`(mockStorageReference.child(anyString())).thenReturn(mockStorageReference)
  //        `when`(mockStorageReference.putFile(any())).thenReturn(any())
  //
  //        fileRepository.updateFile(uid, fileUri, fileType, onSuccess = {
  //            // Success callback
  //            assert(true)
  //        }, onFailure = {
  //            // Failure callback
  ...
  //
  //        `when`(mockStorageReference.child(anyString())).thenReturn(mockStorageReference)
  //        `when`(mockStorageReference.getBytes(anyLong())).thenReturn(Tasks.forResult(byteArray))
  //
  //        fileRepository.getFile(uid, fileType, onSuccess = {
  //            // Success callback
  //            assertNotNull(it)
  //        }, onFailure = {
  //            // Failure callback
